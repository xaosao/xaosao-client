                                        ...
                                        <div className="flex items-start gap-3 flex-1">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    <p className={`font-bold text-base ${['recharge', 'booking_refund'].includes(transaction.identifier) ? 'text-green-600' : 'text-red-600'}`}>
                                                        {['recharge', 'booking_refund'].includes(transaction.identifier) ? '+' : transaction.identifier === "booking_hold" ? "" : '-'}{formatCurrency(transaction.amount)}
                                                    </p>
                                                </div>
                                                <div className="mt-2">
                                ...
                                <div className="hidden sm:flex items-center justify-between">
                                    <div className="flex items-start justify-start space-x-8">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className={`p-3 rounded-md ${statusConfig[transaction.status]?.className.split(' ')[0] || 'bg-gray-100'}`}>
                                                <DollarSign
                                                    size={18}
                                                    className={statusConfig[transaction.status]?.className.split(' ')[1] || 'text-gray-600'}
                                                />
                                        ...
                                        <div className="flex items-center justify-center space-y-1 space-x-4 mt-2">
                                            <p className={`font-semibold ${['recharge', 'booking_refund'].includes(transaction.identifier) ? 'text-green-600' : 'text-red-600'
                                                }`}>
                                                {['recharge', 'booking_refund'].includes(transaction.identifier) ? '+' : transaction.identifier === "booking_hold" ? "" : '-'}{formatCurrency(transaction.amount)}
                                            </p>
                                        </div>
