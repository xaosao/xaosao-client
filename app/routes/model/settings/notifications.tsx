...
type NotificationType = "push" | "sms" | "whatsapp";
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  const notificationsWhatsapp = formData.get("notifications_whatsapp") === "true";
...
export default function ModelNotificationSettings() {
  ...
  const [notifications, setNotifications] = useState({
    ...
    whatsapp: model.sendWhatsappNoti ?? false,
  });
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-4">
          ...
          <div className="flex items-center justify-between border-t border-gray-200 pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900">
                  {t("settings.notification.whatsapp", { defaultValue: "WhatsApp Notifications" })}
                </h3>
                <p className="text-sm text-gray-500">
                  {t("settings.notification.whatsappDesc", { defaultValue: "Receive updates via WhatsApp" })}
                </p>
              </div>
            </div>
            <Switch
