import { Settings, Smartphone, Monitor, RefreshCw, MapPin, Loader, ExternalLink, ChevronDown, ChevronUp } from "lucide-react";
  ...
  return (
    <div className={containerClass}>
      <button
        ...
        className={`flex items-center justify-between w-full font-medium mb-2 ${titleClass}`}
      >
